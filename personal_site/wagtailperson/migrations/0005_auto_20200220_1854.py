...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Shown on the short descriptions",
                        max_length=250,
                ...
                (
                    ...
                    wagtail.core.fields.RichTextField(
                        blank=True, verbose_name="Abstract"
                    ),
                ),
                (
                    "picture",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="wagtailperson_persontag_items",
                        to="taggit.Tag",
                    ),
                ),
            ],
        ...
        migrations.AlterModelOptions(
            ...
            options={
                "verbose_name": "Persons or authors Index Page",
                "verbose_name_plural": "Persons or authors Index Pages",
            },
        ),
        migrations.AlterModelOptions(
            name="personpage",
            options={
                "ordering": ["title"],
                "verbose_name": "Person or author page",
        ...
        migrations.AddField(
            ...
            field=taggit.managers.TaggableManager(
                ...
                through="wagtailperson.PersonTag",
                to="taggit.Tag",
                verbose_name="Tags",
            ),
        ),
